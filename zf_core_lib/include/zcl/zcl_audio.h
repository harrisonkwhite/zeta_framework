...
namespace zf {
    ...
    public:
        ...
        constexpr s_sound_meta Meta() const { return m_meta; }
        constexpr s_array_rdonly<t_f32> PCM() const { return m_pcm; }
    ...
    public:
        ...
        constexpr s_sound_meta Meta() const { return m_meta; }
        constexpr s_array<t_f32> PCM() const { return m_pcm; }

        constexpr operator s_sound_data_rdonly() const { return {m_meta, m_pcm}; }
