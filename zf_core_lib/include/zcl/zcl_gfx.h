...
namespace zf {
    ...
    [[nodiscard]] t_b8 LoadTextureDataFromRaw(const s_str_rdonly file_path, c_arena *const texture_data_arena, c_arena *const temp_arena, s_texture_data *const o_texture_data);

    [[nodiscard]] t_b8 PackTexture(const s_str_rdonly file_path, const s_texture_data texture_data, c_arena *const temp_arena);
    [[nodiscard]] t_b8 UnpackTexture(const s_str_rdonly file_path, c_arena *const texture_data_arena, c_arena *const temp_arena, s_texture_data *const o_texture_data);
