...
namespace zf {
    ...
    struct s_str_rdonly {
        ...
        void MarkCodePoints(t_unicode_code_pt_bit_vec &code_pts) const;
        ...
        t_b8 Walk(t_len &byte_index, s_str_chr_info &o_chr_info) const;

        // byte_index should be initialised to the index of ANY byte in the code point to start walking backwards from.
        // Returns false iff the walk has ended.
        t_b8 WalkReverse(t_len &byte_index, s_str_chr_info &o_chr_info) const;
    };
