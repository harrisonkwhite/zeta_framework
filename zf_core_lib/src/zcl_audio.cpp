...
namespace zf {
    t_b8 LoadSoundDataFromRaw(const s_str_rdonly file_path, s_arena &snd_data_mem_arena, s_arena &temp_mem_arena, s_sound_data &o_snd_data) {
    ...
    t_b8 PackSound(const s_str_rdonly file_path, const s_sound_data snd_data, s_arena &temp_mem_arena) {
    ...
    t_b8 UnpackSound(const s_str_rdonly file_path, s_arena &snd_data_mem_arena, s_arena &temp_mem_arena, s_sound_data &o_snd_data) {
        s_stream fs;
    ...
    t_b8 DeserializeSound(s_stream &stream, s_arena &snd_data_mem_arena, s_sound_data &o_snd_data) {
        s_sound_meta meta;
