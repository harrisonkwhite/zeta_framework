...
zcl::t_b8 pack_assets(const zcl::strs::t_str_rdonly instrs_json_file_path) {
...

    {
        ...
        if (!zcl::io::file_load_contents(instrs_json_file_path, &arena, &arena, &instrs_json_file_contents, true)) {
        ...
        cJSON_ArrayForEach(cj_asset, cj_assets) {
            ...
            case ek_asset_type_font: {
                ...
                if (field_vals[ek_font_field_extra_chrs_file_path]) {
                    ...
                    if (!zcl::io::file_load_contents(extra_chrs_file_path, &arena, &arena, &extra_chrs_file_contents)) {
