...
namespace zf {
    ...
    // arena.
    inline s_sound_type_arena CreateSoundTypeArena(s_audio_sys *const as,
    ...
    [[nodiscard]] t_b8 PlaySound(const s_sound_type *const type,
                                 s_sound_id *const id = nullptr, const t_f32 vol = 1.0f,
                                 const t_f32 pan = 0.0f, const t_f32 pitch = 1.0f,
