...
namespace zf::rendering {
    ...
    constexpr t_b8 vertex_check_valid(const t_vertex vert) {
    ...
    constexpr t_b8 triangle_check_valid(const t_triangle tri) {
    ...
    constexpr t_b8 origin_check_valid(const math::t_v2 origin) {
    ...
    constexpr t_b8 str_alignment_check_valid(const math::t_v2 alignment) {
