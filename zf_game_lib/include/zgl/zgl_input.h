...
namespace zgl {
    ...
    enum t_key_code : zcl::t_i32 {
        ...
        ek_key_code_minus,
        ek_key_code_equals,
        ek_key_code_left_bracket,
        ek_key_code_right_bracket,
        ek_key_code_backslash,
        ek_key_code_semicolon,
        ek_key_code_apostrophe,
        ek_key_code_comma,
        ek_key_code_period,
        ek_key_code_slash,
        ek_key_code_insert,
        ...
        ek_key_code_menu,
        ek_key_code_numpad_0,
        ek_key_code_numpad_1,
        ek_key_code_numpad_2,
        ek_key_code_numpad_3,
        ek_key_code_numpad_4,
        ek_key_code_numpad_5,
        ek_key_code_numpad_6,
        ek_key_code_numpad_7,
        ek_key_code_numpad_8,
        ek_key_code_numpad_9,
        ek_key_code_numpad_decimal,
        ek_key_code_numpad_divide,
        ek_key_code_numpad_multiply,
        ek_key_code_numpad_subtract,
        ek_key_code_numpad_add,
        ek_key_code_numpad_enter,
        ek_key_code_numpad_equals,
