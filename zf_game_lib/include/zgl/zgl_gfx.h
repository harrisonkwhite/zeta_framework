...
namespace zgl::gfx {
    ...
    constexpr zcl::math::t_v2 k_origin_topleft = {0.0f, 0.0f};
    constexpr zcl::math::t_v2 k_origin_topcenter = {0.5f, 0.0f};
    constexpr zcl::math::t_v2 k_origin_topright = {1.0f, 0.0f};
    constexpr zcl::math::t_v2 k_origin_centerleft = {0.0f, 0.5f};
    constexpr zcl::math::t_v2 k_origin_center = {0.5f, 0.5f};
    constexpr zcl::math::t_v2 k_origin_centerright = {1.0f, 0.5f};
    constexpr zcl::math::t_v2 k_origin_bottomleft = {0.0f, 1.0f};
    constexpr zcl::math::t_v2 k_origin_bottomcenter = {0.5f, 1.0f};
    constexpr zcl::math::t_v2 k_origin_bottomright = {1.0f, 1.0f};

    constexpr zcl::math::t_v2 k_alignment_topleft = {0.0f, 0.0f};
    constexpr zcl::math::t_v2 k_alignment_topcenter = {0.5f, 0.0f};
    constexpr zcl::math::t_v2 k_alignment_topright = {1.0f, 0.0f};
    constexpr zcl::math::t_v2 k_alignment_centerleft = {0.0f, 0.5f};
    constexpr zcl::math::t_v2 k_alignment_center = {0.5f, 0.5f};
    constexpr zcl::math::t_v2 k_alignment_centerright = {1.0f, 0.5f};
    constexpr zcl::math::t_v2 k_alignment_bottomleft = {0.0f, 1.0f};
    constexpr zcl::math::t_v2 k_alignment_bottomcenter = {0.5f, 1.0f};
    constexpr zcl::math::t_v2 k_alignment_bottomright = {1.0f, 1.0f};
    ...
    constexpr zcl::t_b8 origin_check_valid(const zcl::math::t_v2 origin) {
        return origin.x >= 0.0f && origin.x <= 1.0f && origin.y >= 0.0f && origin.y <= 1.0f;
    }

    constexpr zcl::t_b8 alignment_check_valid(const zcl::math::t_v2 alignment) {
    ...
    inline void texture_resize_target_if_needed(t_resource *const texture, const zcl::math::t_v2_i size) {
        const zcl::math::t_v2_i size_cur = texture_get_size(texture);
    ...
    void frame_pass_begin_offscreen(t_frame_context *const context, const t_resource *const texture_target, const zcl::math::t_mat4x4 &view_mat = zcl::math::matrix_create_identity(), const zcl::t_b8 clear = false, const zcl::gfx::t_color_rgba32f clear_col = zcl::gfx::k_color_black);
    ...
    inline void frame_submit_triangle(t_frame_context *const context, const zcl::t_static_array<zcl::math::t_v2, 3> &pts, const zcl::t_static_array<zcl::gfx::t_color_rgba32f, 3> &pt_colors) {
    ...
    inline void frame_submit_triangle(t_frame_context *const context, const zcl::t_static_array<zcl::math::t_v2, 3> &pts, const zcl::gfx::t_color_rgba32f color) {
        frame_submit_triangle(context, pts, {{color, color, color}});
    }

    inline void frame_submit_rect(t_frame_context *const context, const zcl::math::t_rect_f rect, const zcl::gfx::t_color_rgba32f color_topleft, const zcl::gfx::t_color_rgba32f color_topright, const zcl::gfx::t_color_rgba32f color_bottomright, const zcl::gfx::t_color_rgba32f color_bottomleft) {
        ZF_ASSERT(rect.width > 0.0f && rect.height > 0.0f);

        const zcl::t_static_array<t_triangle, 2> triangles = {{
            {
                .verts = {{
                    {.pos = zcl::math::rect_get_topleft(rect), .blend = color_topleft, .uv = {0.0f, 0.0f}},
                    {.pos = zcl::math::rect_get_topright(rect), .blend = color_topright, .uv = {1.0f, 0.0f}},
                    {.pos = zcl::math::rect_get_bottomleft(rect), .blend = color_bottomleft, .uv = {1.0f, 1.0f}},
                }},
            },
            {
                .verts = {{
                    {.pos = zcl::math::rect_get_bottomleft(rect), .blend = color_bottomleft, .uv = {1.0f, 1.0f}},
                    {.pos = zcl::math::rect_get_topright(rect), .blend = color_topright, .uv = {0.0f, 1.0f}},
                    {.pos = zcl::math::rect_get_bottomright(rect), .blend = color_bottomright, .uv = {0.0f, 0.0f}},
                }},
            },
        }};
    ...
    inline void frame_submit_rect_rotated(t_frame_context *const context, const zcl::math::t_v2 pos, const zcl::math::t_v2 size, const zcl::math::t_v2 origin, const zcl::t_f32 rot, const zcl::gfx::t_color_rgba32f color) {
