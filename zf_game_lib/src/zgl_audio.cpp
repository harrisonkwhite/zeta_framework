...
namespace zf {
    ...
    t_b8 CreateAudioSys(s_mem_arena &mem_arena, s_audio_sys *&o_as) {
    ...
    void DestroySoundTypes(const s_sound_type_arena &type_arena) {
        s_audio_sys &as = *type_arena.audio_sys;
    ...
    t_b8 PlaySound(const s_sound_type &type, s_sound_id *const o_id, const t_f32 vol, const t_f32 pan, const t_f32 pitch, const t_b8 loop) {
