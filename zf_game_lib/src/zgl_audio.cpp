...
namespace zf {
    ...
    t_b8 InitAudioSys(s_mem_arena& mem_arena, s_audio_sys*& o_as) {
    ...
    t_b8 PlaySound(s_audio_sys& as, const s_sound_type* const type, s_sound_id* const o_id, const t_f32 vol, const t_f32 pan, const t_f32 pitch, const t_b8 loop) {
