...
namespace zf {
    void internal::ProcKeyAction(const s_ptr<s_input_state> is, const e_key_code code, const e_key_action act) {
    ...
    void internal::ProcMouseButtonAction(const s_ptr<s_input_state> is, const e_mouse_button_code code, const e_mouse_button_action act) {
    ...
    void internal::ProcCursorMove(const s_ptr<s_input_state> is, const s_v2 pos) {
        is->cursor_pos = pos;
    }

    void internal::ProcScroll(const s_ptr<s_input_state> is, const s_v2 scroll) {
