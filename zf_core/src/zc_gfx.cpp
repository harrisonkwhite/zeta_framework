...
namespace zf {
    t_b8 LoadTextureFromRaw(const s_str_rdonly file_path, c_mem_arena& mem_arena, s_texture_data& o_tex_data) {
    ...
    t_b8 LoadTextureFromPacked(const s_str_rdonly file_path, c_mem_arena& mem_arena, s_texture_data& o_tex_data) {
        ZF_ASSERT(IsStrTerminated(file_path));
    ...
    t_b8 PackTexture(const s_texture_data& tex_data, const s_str_rdonly file_path, c_mem_arena& temp_mem_arena) {
        ZF_ASSERT(IsStrTerminated(file_path));
