...
namespace zf {
    ...
    [[nodiscard]] t_b8 LoadSoundFromRaw(const s_str_ascii_rdonly file_path, s_mem_arena& mem_arena, s_sound_meta& o_snd_meta, s_array<t_f32>& o_snd_pcm);
    ...
    [[nodiscard]] t_b8 PackSound(const s_str_ascii_rdonly dest_file_path, const s_str_ascii_rdonly src_file_path, s_mem_arena& temp_mem_arena);
    [[nodiscard]] t_b8 UnpackSound(const s_str_ascii_rdonly file_path, s_mem_arena& mem_arena, s_sound_data& o_snd_data);
}
