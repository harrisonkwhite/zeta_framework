...
namespace zf {
    ...
    c_gfx_resource_handle c_gfx_resource_arena::AddTexture(const s_texture_data& tex_data) {
        if (m_hdls_taken == m_hdls.Len()) {
            return {};
        }
    ...
    t_b8 s_texture::Load(const s_texture_data& tex_data, c_gfx_resource_arena& gfx_res_arena) {
