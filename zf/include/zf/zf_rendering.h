...
namespace zf {
    ...
    [[nodiscard]] t_b8 DrawStr(const s_rendering_context& rc, const s_str_rdonly str, const gfx::s_font_asset& font, const s_v2<t_f32> pos, const s_v2<t_f32> alignment, s_mem_arena& temp_mem_arena);
