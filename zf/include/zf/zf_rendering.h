...
namespace zf {
    ...
    struct s_rendering_basis {
        ...
        [[nodiscard]] t_b8 Init(s_gfx_resource_arena& gfx_res_arena, s_mem_arena& temp_mem_arena);
    };
    ...
    class c_renderer {
    public:
        t_b8 Init(s_gfx_resource_arena& gfx_res_arena, s_mem_arena& mem_arena, s_mem_arena& temp_mem_arena);
        ...
        void DrawTexture(const s_texture_asset& tex, const s_v2<t_f32> pos, const s_rect<t_s32> src_rect = {}, const s_v2<t_f32> origin = origins::g_topleft, const s_v2<t_f32> scale = {1.0f, 1.0f}, const t_f32 rot = 0.0f, const s_color_rgba32f blend = colors::g_white);
    ...
    private:
        ...
        void Draw(const s_gfx_resource_handle tex_hdl, const s_rect<t_f32> tex_coords, s_v2<t_f32> pos, s_v2<t_f32> size, s_v2<t_f32> origin, const t_f32 rot, const s_color_rgba32f blend);
        void Flush();
    };
}
